...
CREATE TABLE [dbo].[Customers](
	[customerNo] [int] NOT NULL IDENTITY(00000,00001) PRIMARY KEY,
	[contractNo] [nchar](10) NOT NULL,
	[firstName] [nvarchar](50) NOT NULL,
	[lastName] [nvarchar](50) NOT NULL,
	[streetNo] [nchar](10) NOT NULL,
	...
	[creditCardProvider] [nvarchar](50) NOT NULL,
...
CREATE TABLE [dbo].[Contracts](
	[contractNo] [int] NOT NULL IDENTITY(00000,00001) PRIMARY KEY,
	[empNo] [int] NOT NULL,
	...
	[observationsOut] [nvarchar](300) NOT NULL,
	[observationsIn] [nvarchar](300) NULL,
)
GO

CREATE TABLE [dbo].[Employees](
	[empNo] [int] NOT NULL IDENTITY(00000,00001) PRIMARY KEY,
	[firstName] [nvarchar](50) NOT NULL,
	[lastName] [nvarchar](50) NOT NULL,
	[mobPhone] [int] NOT NULL,
	[homePhone] [int] NULL,
	...
	[residencyState] [nchar](10) NOT NULL,
	[driverLicenceNo] [nchar](10) NOT NULL,
	[emergencyFirstName] [nvarchar](50) NULL,
	[emergencyLastName] [nvarchar](50) NULL,
...
CREATE TABLE [dbo].[Vehicle_Services](
	[serviceNo] [int] NOT NULL IDENTITY(00000,00001) PRIMARY KEY,
	[VIN] [nchar](10) NOT NULL,
	[serviceTime] [time](0) NOT NULL,
	[serviceDate] [date] NOT NULL,
	[returnTime] [time](0) NULL,
	[returnDate] [date] NULL,
	[servicePrice] [money] NOT NULL,
	[vehicleChanges] [nvarchar](300) NULL,
	[observationsIn] [nvarchar](300) NOT NULL,
